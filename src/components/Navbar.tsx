      ...
      <nav className="lg:flex items-center space-x-6 relative bg-[#F4EBDD] p-2 pl-6 hidden">
        ...
        <div className="relative">
          ...
          {openDropdown === "dashboard" && (
            <ul className="absolute bg-white shadow-md rounded-md py-2 w-32 border border-black">
              <li>
                <a
        ...
        <div className="relative">
          ...
          {openDropdown === "web" && (
            <ul className="absolute bg-white shadow-md rounded-md py-2 w-32 border border-black transition-transform duration-300 transform ease-in-out">
              <li>
                <a
                  href="/web/design"
                  className="block px-1 py-2 text-sm border border-transparent hover:bg-[#F4EBDD] hover:border-[#F1E5D1] transition-all duration-300"
          ...
          {openDropdown === "masters" && (
            <ul className="absolute bg-white shadow-md rounded-md py-2 w-32 border border-black transition-transform duration-300 transform ease-in-out ">
              <li>
                <a
                  href="/masters/data"
                  className="block px-1 py-2 text-sm border border-transparent hover:bg-[#F4EBDD] hover:border-[#F1E5D1] transition-all duration-300 whitespace-nowrap"
                >
                  Data Management
                </a>
              </li>
